        ...
        <AnimatePresence mode="wait">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {SERVICES.map((service) => (
                  <div 
                    ...
                    className={`p-4 border cursor-pointer transition-all flex justify-between items-center group ${
                    ...
                    {dates.map((date) => {
                        ...
                        return (
                            <button
                                ...
                                className={`min-w-[70px] p-3 text-center border transition-all ${
          ...
          {step === 3 && (
            ...
            >
              ...
              <div className="bg-[#faf9f6] p-6 border border-[#e7e5e4] mb-8">
                <div className="flex items-start gap-4 mb-4">
                    <div className="bg-white p-2 rounded-full border border-[#e7e5e4]">
                        <CheckCircle className="w-5 h-5 text-[#849b87]" />
                    </div>
                    <div>
                        <p className="text-xs uppercase tracking-widest text-[#a8a29e]">Trattamento</p>
              ...
              {isSubmitting ? (
                ...
                <div className="flex justify-between mt-8">
                    ...
                    <button 
                        ...
                        className="bg-[#849b87] text-white px-8 py-3 uppercase tracking-widest text-xs hover:bg-[#6b7e6d] transition-colors shadow-lg"
                    >
          ...
          {step === 4 && (
           ...
           >
             ...
             <h3 className="text-3xl font-serif text-[#292524] mb-4">Prenotazione Confermata</h3>
             <p className="text-[#57534e] max-w-md mx-auto mb-8">
                 Abbiamo inviato una conferma alla tua email e l'appuntamento è stato sincronizzato con il calendario dello studio.
             </p>
             <button 
