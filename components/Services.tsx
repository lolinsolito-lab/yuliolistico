...
const Services: React.FC = () => {
  return (
    <section id="esperienze" className="py-32 px-6 bg-[#faf9f6]">
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-end mb-20 border-b border-[#292524]/10 pb-8">
          <div>
            <span className="text-[#c07a60] uppercase tracking-[0.2em] text-xs font-bold">Le Nostre</span>
            <h2 className="text-4xl md:text-7xl font-serif text-[#292524] mt-2">Esperienze.</h2>
          </div>
          <p className="max-w-md text-[#57534e] mt-6 md:mt-0 font-light text-right">
            Ogni corpo ha una storia. Ogni rituale la ascolta. <br />
